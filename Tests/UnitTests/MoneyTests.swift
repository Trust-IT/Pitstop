...
struct MoneyTests {
    @Test func initWithInvalidString() throws {
    ...
    @Test func initWithInvalidSeparator() throws {
    ...
    @Test func initWithValidStringDecimal() throws {
    ...
    @Test func initWithValidStringNoDecimal() throws {
    ...
    @Test func descriptionWithZeroAmount() throws {
    ...
    @Test func descriptionWithPositiveDecimal() throws {
    ...
    @Test func descriptionWithNegativeDecimal() throws {
    ...
    @Test func valueWithLargeDecimal() throws {
